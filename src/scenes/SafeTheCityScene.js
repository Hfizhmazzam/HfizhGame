...
export default class SafeTheCityScene extends Phaser.Scene {
    constructor() {
      super("safe-the-city-scene");
    }
    ...
    this.load.image("handsanitizer", "images/star.png");
    this.load.audio("handsanitizerSound", "sfx/windows-xp-startup.mp3w");
    this.load.audio("laserSound", "sfx/renetti_fire_npc_01.mp3");
    this.load.audio("destroySound", "sfx/explode1_5uz7VYc.mp3");
  ...
  createButton() {
    ...
    movePlayer(player, time) {
      if (this.cursors.left.isDown || this.nav_left) {
        this.player.setVelocityX(this.speed * -5);
        ...
        this.player.setVelocityY(this.speed * -5);
